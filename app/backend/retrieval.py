...
def init_all(data_path='app/backend/indexed_data.csv', embedder_name='sergeyzh/rubert-tiny-turbo',
             index_path='app/backend/index.faiss', embeddings_path='app/backend/embeddings.npz',
...
def index_new_data(new_data_csv_filepath='app/backend/temp_data.csv', save_index_path='app/backend/index.faiss',
